...
export class EmpleoService {
  ...
  getAll(filtro?: EmpleoFiltro): Observable<Empleo[]> {
    ...
    if (filtro) {
      ...
      if (filtro.modalidad) params = params.set('modalidad', filtro.modalidad.toString());
      if (filtro.tipoContrato) params = params.set('tipoContrato', filtro.tipoContrato.toString());
